    ...
    source.subscribe(
      createOperatorSubscriber(
        ...
        (value) => {
          ...
          if (toEmit) {
            for (const buffer1 of toEmit) {
              arrRemove(buffers, buffer1);
              subscriber.next(buffer1);
            }
          }
        },
        () => {
...
function combineLatest1(...args) {
  const resultSelector = popResultSelector(args);
  return resultSelector
    ? pipe(combineLatest1(...args), mapOneOrManyArgs(resultSelector))
    : operate((source, subscriber) => {
        combineLatestInit([source, ...argsOrArgArray(args)])(subscriber);
      });
}
function combineLatestWith(...otherSources) {
  return combineLatest1(...otherSources);
}
...
function connect(selector, config = DEFAULT_CONFIG1) {
...
function last1(predicate, defaultValue) {
  const hasDefaultValue = arguments.length >= 2;
  return (source) =>
    source.pipe(
      predicate ? filter((v, i) => predicate(v, i, source)) : identity,
        ...
        createOperatorSubscriber(subscriber, undefined, undefined, (err) => {
          if (!errors$) {
            ...
            innerFrom(notifier(errors$)).subscribe(
              createOperatorSubscriber(subscriber, () => (innerSub ? subscribeForRetryWhen() : (syncResub = true)))
            );
          }
          if (errors$) {
            errors$.next(err);
...
function window(windowBoundaries) {
  return operate((source, subscriber) => {
    ...
    source.subscribe(
      createOperatorSubscriber(
        subscriber,
        (value) => (windowSubject === null || windowSubject === void 0 ? void 0 : windowSubject.next(value)),
        () => {
      ...
      createOperatorSubscriber(
        ...
        (value) => {
          ...
          if (++count % startEvery === 0) {
            ...
            subscriber.next(window1.asObservable());
          }
        },
        () => {
...
function zip1(...sources) {
  return operate((source, subscriber) => {
    zip(source, ...sources).subscribe(subscriber);
  });
}
function zipWith(...otherInputs) {
  return zip1(...otherInputs);
}
export { Observable as Observable };
export { ConnectableObservable as ConnectableObservable };
export { observable as observable };
export { animationFrames as animationFrames };
export { Subject as Subject };
export { BehaviorSubject as BehaviorSubject };
export { ReplaySubject as ReplaySubject };
export { AsyncSubject as AsyncSubject };
export { asap as asap, asapScheduler as asapScheduler };
export { async as async, asyncScheduler as asyncScheduler };
export { queue as queue, queueScheduler as queueScheduler };
export { animationFrame as animationFrame, animationFrameScheduler as animationFrameScheduler };
export { VirtualTimeScheduler as VirtualTimeScheduler, VirtualAction as VirtualAction };
export { Scheduler as Scheduler };
export { Subscription as Subscription };
export { Subscriber as Subscriber };
export { Notification as Notification, NotificationKind as NotificationKind };
export { pipe as pipe };
export { noop as noop };
export { identity as identity };
export { isObservable as isObservable };
export { lastValueFrom as lastValueFrom };
export { firstValueFrom as firstValueFrom };
export { ArgumentOutOfRangeError as ArgumentOutOfRangeError };
export { EmptyError as EmptyError };
export { NotFoundError as NotFoundError };
export { ObjectUnsubscribedError as ObjectUnsubscribedError };
export { SequenceError as SequenceError };
export { TimeoutError as TimeoutError };
export { UnsubscriptionError as UnsubscriptionError };
export { bindCallback as bindCallback };
export { bindNodeCallback as bindNodeCallback };
export { combineLatest as combineLatest };
export { concat as concat };
export { connectable as connectable };
export { defer as defer };
export { empty as empty };
export { forkJoin as forkJoin };
export { from as from };
export { fromEvent as fromEvent };
export { fromEventPattern as fromEventPattern };
...
export { of as of };
export { onErrorResumeNext as onErrorResumeNext };
export { pairs as pairs };
...
export { auditTime as auditTime };
export { buffer as buffer };
export { bufferCount as bufferCount };
export { bufferTime as bufferTime };
export { bufferToggle as bufferToggle };
export { bufferWhen as bufferWhen };
export { catchError as catchError };
export { combineLatestAll as combineAll };
export { combineLatestAll as combineLatestAll };
export { combineLatestWith as combineLatestWith };
export { concatAll as concatAll };
export { concatMap as concatMap };
export { concatMapTo as concatMapTo };
export { concatWith as concatWith };
export { connect as connect };
export { count as count };
export { debounce as debounce };
export { debounceTime as debounceTime };
export { defaultIfEmpty as defaultIfEmpty };
export { delay as delay };
export { delayWhen as delayWhen };
export { dematerialize as dematerialize };
export { distinct as distinct };
export { distinctUntilChanged as distinctUntilChanged };
export { distinctUntilKeyChanged as distinctUntilKeyChanged };
export { elementAt as elementAt };
export { endWith as endWith };
export { every as every };
export { exhaustAll as exhaust };
export { exhaustAll as exhaustAll };
export { exhaustMap as exhaustMap };
export { expand as expand };
export { filter as filter };
export { finalize as finalize };
export { find as find };
export { findIndex as findIndex };
export { first as first };
export { groupBy as groupBy };
export { ignoreElements as ignoreElements };
export { isEmpty as isEmpty };
export { last1 as last };
export { map as map };
export { mapTo as mapTo };
export { materialize as materialize };
export { max as max };
export { mergeAll as mergeAll };
export { mergeMap as flatMap };
export { mergeMap as mergeMap };
export { mergeMapTo as mergeMapTo };
export { mergeScan as mergeScan };
export { mergeWith as mergeWith };
export { min as min };
export { multicast as multicast };
export { observeOn as observeOn };
export { onErrorResumeNextWith as onErrorResumeNextWith };
export { pairwise as pairwise };
export { pluck as pluck };
export { publish as publish };
export { publishBehavior as publishBehavior };
export { publishLast as publishLast };
export { publishReplay as publishReplay };
export { raceWith as raceWith };
export { reduce as reduce };
export { repeat as repeat };
export { repeatWhen as repeatWhen };
export { retry as retry };
export { retryWhen as retryWhen };
export { refCount as refCount };
export { sample as sample };
export { sampleTime as sampleTime };
export { scan as scan };
export { sequenceEqual as sequenceEqual };
export { share as share };
export { shareReplay as shareReplay };
export { single as single };
export { skip as skip };
export { skipLast as skipLast };
export { skipUntil as skipUntil };
export { skipWhile as skipWhile };
export { startWith as startWith };
export { subscribeOn as subscribeOn };
export { switchAll as switchAll };
export { switchMap as switchMap };
export { switchMapTo as switchMapTo };
export { switchScan as switchScan };
export { take as take };
export { takeLast as takeLast };
export { takeUntil as takeUntil };
export { takeWhile as takeWhile };
export { tap as tap };
export { throttle as throttle };
export { throttleTime as throttleTime };
export { throwIfEmpty as throwIfEmpty };
export { timeInterval as timeInterval };
export { timeout as timeout };
export { timeoutWith as timeoutWith };
export { timestamp as timestamp };
export { toArray as toArray };
export { window as window };
export { windowCount as windowCount };
export { windowTime as windowTime };
export { windowToggle as windowToggle };
export { windowWhen as windowWhen };
export { withLatestFrom as withLatestFrom };
export { zipAll as zipAll };
export { zipWith as zipWith };
